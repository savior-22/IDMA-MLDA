...
def load_drug_mol_data():
    ...
    data = pd.read_csv(r'/Users/Desktop/博士/Drug on microbe/long-tailed data/using_now/drug_smiles.csv')
    drug_id_mol_tup = []
    symbols = list()
    drug_smile_dict = {}
    ...
    with open(r'/Users/Desktop/博士/Drug on microbe/long-tailed data/using_now/drug_data1.pkl', 'wb') as f:
